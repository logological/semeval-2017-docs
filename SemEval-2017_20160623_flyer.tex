...
% distribution at the task website.
%
...
\hypersetup{
  pdftitle={Call for Participation: SemEval-2017 Shared Task on the Detection and Interpretation of English Puns},
  pdfauthor={Tristan Miller},
  pdfsubject={SemEval-2017 Shared Task on the Detection and Interpretation of English Puns},
  pdffitwindow=true,
  pdftoolbar=false,
  pdfmenubar=false
}
